...
namespace TimeTableM
{
    public partial class ManageLecturers : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "SELECT `LecName` as LECTURENAME, `EmpID` as ID, `Faculty` as FACULTY, `Department` as DEPARTMENT, `Center` as CENTER, `Building` as BUILDING, `Level` as LEVEL, `Rank` as RANK FROM `addlecture`";
