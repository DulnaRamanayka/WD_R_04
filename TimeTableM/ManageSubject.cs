...
namespace TimeTableM
{
    public partial class ManageSubject : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "SELECT `department` as DEPARTMENT, `OfferdYear` as OFFERDYEAR, `OfferedSem` as SEMSETER, `SubjectName` as SUBJECTNAME, `SubjectCode` as SUBCODE, `NoOfLecHours` as LECHOURS, `NoOfTuHours` as TUTEHOURS, `NoOfLabHours` as LABHOURS, `NoOfEveHours` as EVEHOURS FROM `addsubject`";
